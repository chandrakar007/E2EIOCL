...
public class CustomerProfile extends BaseClass {
	...
	public CustomerProfile() 
	{
	   ...
	   WebElement enterPan;
	   @FindBy(css="div[class='main'] div[class='input-container']")
...
//	
	   ...
	   public void navigateToAddCustomer(String pAN, String PinCode, String cstmrType, String subScstmrType, String stateofc,
				String divisnOfc) throws InterruptedException, AWTException {
		...
		//  driver.findElement(By.cssSelector("div[class='main'] div[class='input-container']")).sendKeys("123344");
		 // Thread.sleep(1000);
		  ActionClass.type(enterPinCode, PinCode);
		 // enterPinCode.sendKeys("201301");
		 // ActionClass.click(driver, enterPan);
...
//		   driver.findElement(By.xpath("//div[@class='main']//button[@type='button'][normalize-space()='Upload']")).click();
//
//		  ActionClass.type(customerType, cstmrType);
//		  ActionClass.type(subcustomerType, subScstmrType);
//		  ActionClass.type(stateOffice, stateofc);
//		  ActionClass.type(divisionOfc, divisnOfc);
...
//	public void FillCustomerData(String PAN, String PIN, 
//			String CustomerType,
//			String SubCustomerType,
//			String Stateoffice,
//			String DivisionOffice,
//			String TransportHub) throws AWTException, InterruptedException {
...
//			String SubCustomerType,
//			String Stateoffice,
//			String DivisionOffice) throws InterruptedException, AWTException {
//		// TODO Auto-generated method stub
//		ActionClass.type(enterPan, PAN);
//	    ActionClass.type(enterPin, PIN);
//	    ActionClass.click(driver, enterPan);
